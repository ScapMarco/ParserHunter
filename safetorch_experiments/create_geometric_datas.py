...
def create_and_save_geometric_datas_list(path_binary, path_dictionary, path_python_executable, path_script_embedding_model, path_output_file):
...
def automatize_create_and_save_geometric_datas_list(path_bash_script, path_labeled_dictionaries, path_out_files, path_python_executable, path_script_embedding_model):
    '''
...
def main(path_bash_scripts):
    for path_bash_script in path_bash_scripts:
        automatize_create_and_save_geometric_datas_list(
            ...
            path_python_executable = "", # change to your python executable for the embedding model
            path_script_embedding_model = "./safetorch/safetorch_inference.py" # path to the script to generate the instruction embeddings
        )
...
if __name__ == "__main__":
    ...
    # Launched from ParserHunter/ with python -m safetorch_experiments.create_geometric_datas